  ...
  <div class="wrapper-blog" v-if="!loading">
    ...
    >
      <div class="container">
        ...
        <div class="row test">
          <div class="col-xl-3">
            <div class="left-menu" id="list-categories-menu">
              <div class="sidebar">
...
export default defineComponent({
  ...
  methods:{
      handleSCroll (event) {
        ...
        let testScrollHeight = header.scrollHeight;
        if (window != 'undefined' && window.scrollY > 800 && window.scrollY < (testScrollHeight+300) && !header.className.includes('test--bgchange')) {
        header.classList.add('test--bgchange'); 
        } else if (window != 'undefined' && window.scrollY < 800 || window.scrollY > (testScrollHeight+300)) {
          header.classList.remove('test--bgchange');
        }
      },
    },
    mounted () {
